...
async fn test_top_level_span_created() {
    ...
    let _result = orchestrator.execute("test task", CancellationToken::new(), None, None).await.unwrap();
...
async fn test_wave_spans_created() {
    ...
    let _result = orchestrator.execute("wave test", CancellationToken::new(), None, None).await.unwrap();
...
async fn test_step_spans_created() {
    ...
    let _result = orchestrator.execute("step test", CancellationToken::new(), None, None).await.unwrap();
...
async fn test_state_transition_events() {
    ...
    let _result = orchestrator.execute("state test", CancellationToken::new(), None, None).await.unwrap();
...
async fn test_failure_events() {
    ...
    let _result = orchestrator.execute("failure test", CancellationToken::new(), None, None).await.unwrap();
...
async fn test_span_hierarchy() {
    ...
    let _result = orchestrator.execute("hierarchy test", CancellationToken::new(), None, None).await.unwrap();
