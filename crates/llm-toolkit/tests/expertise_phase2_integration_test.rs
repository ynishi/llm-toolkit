...
fn test_context_filtering_by_task_type() {
    ...
    let security_prompt = expertise.to_prompt_with_context(&security_context);
    ...
    let code_prompt = expertise.to_prompt_with_context(&code_context);
...
fn test_context_filtering_by_user_state() {
    ...
    // Beginner context
    let beginner_prompt =
        expertise.to_prompt_with_context(&RenderContext::new().with_user_state("beginner"));
    ...
    // Expert context
    let expert_prompt =
        expertise.to_prompt_with_context(&RenderContext::new().with_user_state("expert"));
...
fn test_multiple_user_states() {
    ...
    let prompt1 = expertise.to_prompt_with_context(&context1);
    ...
    let prompt2 = expertise.to_prompt_with_context(&context2);
...
fn test_combined_context_conditions() {
    ...
    let matching_prompt = expertise.to_prompt_with_context(&matching_context);
    ...
    let partial_prompt = expertise.to_prompt_with_context(&partial_context);
...
fn test_priority_based_ordering() {
    ...
    let prompt = expertise.to_prompt_with_context(&RenderContext::new());
...
fn test_empty_context_matches_always_only() {
    ...
    let prompt = expertise.to_prompt_with_context(&empty_context);
...
fn test_no_matching_fragments() {
    ...
    let prompt = expertise.to_prompt_with_context(&wrong_context);
...
fn test_backward_compatibility_with_legacy_to_prompt() {
    ...
    let new_prompt = expertise.to_prompt_with_context(&RenderContext::new());
