...
**Why?** The orchestrator's `context` is internal. Only `final_output` (the last step's result) is returned. Design your workflow so the final agent aggregates all necessary information.
